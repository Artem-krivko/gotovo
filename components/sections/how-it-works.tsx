...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description:
      "Генератор собирает три живые концепции: разные варианты структуры, подачи и визуального характера.",
  ...
  },
  {
    ...
    description:
      "Сравниваете направления. Если одно подходит — оставляете заявку и обсуждаем полноценную разработку.",
