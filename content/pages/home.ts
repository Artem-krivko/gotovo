...
export const metadata: Metadata = {
  ...
  description:
    "Разработка сайтов для бизнеса. Бесплатная AI-концепт-лаборатория помогает сравнить первые визуальные направления до старта проекта.",
};
...
export const homeContent: HomePageContent = {
  ...
  hero: {
    ...
    subtitle:
      "Опишите бизнес — ИИ соберёт первую визуальную концепцию. Это способ быстро проверить направление, а не обещание финального сайта за полминуты.",
    cta: {
    ...
    metrics: [
      { value: "≈ 30 сек", label: "первая AI-концепция" },
    ...
    items: [
      {
        ...
        answer:
          "Нет. Генератор создаёт первые визуальные гипотезы. Финальный сайт разрабатывается отдельно — с вашим контентом, адаптивом и нужными функциями.",
      },
      {
        question: "Сколько стоит сайт?",
        answer:
          "Лендинг — от 1 200 BYN, бизнес-сайт — от 2 900 BYN, индивидуальный проект — от 4 900 BYN. Точную смету фиксируем после короткого брифа.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Поэтапно 30/40/30. Каждый платёж привязан к понятному результату: старту, согласованной промежуточной версии и публикации.",
      },
      {
  ...
  cta: {
    ...
    subtitle:
      "Попробуйте генератор бесплатно или оставьте заявку — вернёмся с вопросами в течение рабочего дня.",
