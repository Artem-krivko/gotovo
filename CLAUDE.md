...
## 🎨 ДИЗАЙН-СИСТЕМА V1 (АКТУАЛЬНО С 2026-08-31)

Главная, шапка и футер переведены на редакционную светлую систему. Палитра:
paper `#F2EFE7`, ink `#171712`, cobalt `#2656D8`, signal `#FF6542`, acid
`#D8FF52`. Основа — строгая сетка, крупная типографика, прямые углы и
контрастные цветовые поля. Space Grotesk остаётся основным шрифтом, Georgia
используется только как акцентный italic serif.

Внутренние страницы ещё мигрируют и временно используют старую тёмную тему.
Новые публичные секции должны продолжать V1; не копируй legacy-стили ниже.

Коммерческие формулировки: лендинг от 1 200 BYN, бизнес-сайт от 2 900 BYN,
индивидуальный проект от 4 900 BYN, расширенное SEO от 600 BYN, оплата
30/40/30. Генератор создаёт первую AI-концепцию, а не готовый дизайн или сайт.

## 🎨 LEGACY-СИСТЕМА ВНУТРЕННИХ СТРАНИЦ

> Подробности в `_ai-skills/designer.md`. Здесь — самое критичное.

### Тема: тёмная (только для ещё не мигрированных страниц)
```
...
5. **Для новых секций используй V1** — светлая редакционная система описана выше
