...
export const metadata: Metadata = {
  ...
  description:
    "Разработка сайтов для малого и среднего бизнеса. Лендинги от 1 200 BYN, бизнес-сайты от 2 900 BYN. Работаем по Беларуси.",
  alternates: { canonical: `${SITE_URL}/sozdanie-sajtov-dlya-biznesa` },
  openGraph: {
    title: "Создание сайтов для бизнеса | gotovo",
    description: "Лендинги и бизнес-сайты под ключ. Бесплатная AI-концепция. От 1 200 BYN.",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { "@type": "Answer", text: "Для одной услуги обычно достаточно лендинга от 1 200 BYN. Бизнес-сайт от 2 900 BYN нужен, когда направлений несколько. AI-генератор поможет бесплатно проверить визуальное направление." },
      },
      {
        "@type": "Question",
...
const FAQ_ITEMS = [
  {
    ...
    answer: "Для одной услуги обычно достаточно лендинга от 1 200 BYN. Бизнес-сайт от 2 900 BYN нужен, когда направлений несколько. AI-генератор поможет бесплатно проверить визуальное направление.",
  },
  {
  ...
  },
  {
    ...
    answer: "Окупаемость зависит от среднего чека, маржи и источника трафика. До старта определяем целевое действие сайта и метрики, по которым вы сможете оценить результат.",
  },
  {
  ...
  },
  {
    ...
    answer: "Да, работаем с ИП и небольшими компаниями. Порог входа — от 1 200 BYN, оплата по этапам 30/40/30.",
  },
];
      ...
      <section className="relative overflow-hidden bg-[#0A0A0F] px-4 pb-16 pt-14 sm:px-6 sm:pb-24 sm:pt-20">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="reveal-up delay-2 mt-5 mx-auto max-w-2xl text-lg leading-7 text-[#A1A1B5]">
            ...
            <strong className="text-white">AI-генератор соберёт первую визуальную концепцию</strong>{" "}
            — бесплатно, чтобы быстрее обсудить направление.
          </p>
          ...
          <div className="reveal-up delay-4 mt-10 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              { value: "от 1 200 BYN", label: "Лендинг" },
              { value: "от 2 900 BYN", label: "Бизнес-сайт" },
