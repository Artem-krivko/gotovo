...
export const metadata: Metadata = {
  ...
  description: "gotovo — независимая веб-студия из Беларуси. AI ускоряет поиск направления, человек отвечает за дизайн, разработку и качество. Лендинги от 1 200 BYN.",
