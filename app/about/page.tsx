...
import { EditorialBreadcrumbs, EditorialCta, EditorialHero, EditorialSectionHeader } from "@/components/shared/editorial";
      ...
      <section className="bg-ink px-4 py-16 text-paper sm:px-6 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-12">
            <p className="text-lg leading-8 text-paper/72 lg:col-start-4 lg:col-span-5">gotovo только начинает коммерческую историю. Поэтому вместо длинного списка логотипов — прямой контакт, аккуратный процесс и ответственность за каждое решение.</p>
            <p className="text-sm leading-7 text-paper/52 lg:col-span-4">По мере запуска реальных проектов здесь появятся кейсы с контекстом, ограничениями и измеримым результатом — только с разрешения клиентов.</p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-10 grid border-l border-t border-ink/25 md:grid-cols-2">
            {principles.map(([title, text], index) => (
              <article key={title} className="min-h-64 border-b border-r border-ink/25 p-6 sm:p-8">
      ...
      <section className="bg-cobalt px-4 py-16 text-white sm:px-6 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-10 grid gap-px bg-white/20 lg:grid-cols-2">
            <div className="bg-cobalt p-7 sm:p-10">
