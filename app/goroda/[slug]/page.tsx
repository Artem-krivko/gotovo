  ...
  return [
    {
      ...
      answer: `Лендинг от 1 200 BYN, бизнес-сайт от 2 900 BYN. Цена не зависит от города — мы работаем удалённо по всей Беларуси. AI-генератор помогает проверить визуальное направление до старта.`,
    },
    {
