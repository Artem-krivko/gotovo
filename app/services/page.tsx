...
export default function ServicesPage() {
  return (
    <main className="bg-paper text-ink">
      ...
      <EditorialVisual
        src="/images/services-system-v1.jpg"
        alt="Печатная система веб-компонентов, сеток и цветовых проб"
        label="Система / не набор экранов"
        caption="Структура, типографика, компоненты и адаптивные состояния проектируются как единое целое — так сайт остаётся последовательным при развитии."
        priority
      />
      <section className="px-4 py-16 sm:px-6 sm:py-24 lg:py-32" id="formats">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-10 border-t border-ink">
            {formats.map((item) => (
              <article key={item.title} className="grid gap-7 border-b border-ink/25 py-8 lg:grid-cols-12 lg:py-12" data-reveal>
