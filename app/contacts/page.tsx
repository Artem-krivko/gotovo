...
function TelegramIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M21.8 3.1L1.4 10.8c-1.3.5-1.3 1.3-.2 1.6l5.2 1.6 2 6.2c.3.8.4 1.1 1 1.1s.8-.3 1.1-.6l2.5-2.4 5.2 3.8c1 .5 1.7.2 1.9-.9l3.4-16c.3-1.4-.5-2-1.7-1.1z"
...
const CONTACT_ICONS = [TelegramIcon, EmailIcon];
        ...
        <div className="mx-auto max-w-6xl grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="reveal-up delay-1 rounded-2xl border border-white/10 bg-[#13131A] p-6 sm:p-7">
              ...
              <p className="mt-1 text-sm text-[#6B6B80]">Без формы, просто в мессенджер</p>
            ...
            <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-xl">
                ...
                <h2 className="mt-2 text-2xl font-bold tracking-tight text-white sm:text-3xl">
                  Начните с генератора — бесплатно
                </h2>
                <p className="mt-2 text-sm text-[#A1A1B5]">
                  Опишите бизнес, получите дизайн за 30 секунд. Понравится — тогда напишете.
                </p>
              </div>
              <Link href="/generator"
