...
export const metadata: Metadata = {
  title: "AI генератор концепта сайта — бесплатно за 30 секунд | gotovo",
  description:
    "Получите концепт сайта за 30 секунд с помощью ИИ. Бесплатно, без регистрации. Опишите бизнес — AI соберёт структуру и оформление. Подходит направление — доведём до готового сайта.",
  alternates: { canonical: `${SITE_URL}/ai-generator-sajta` },
  openGraph: {
    title: "AI генератор дизайна сайта | gotovo",
    description: "Концепт сайта за 30 секунд — бесплатно. Опишите бизнес, AI соберёт структуру и оформление.",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { "@type": "Answer", text: "AI генератор сайтов — инструмент который создаёт дизайн сайта по текстовому описанию вашего бизнеса. Вы описываете компанию, выбираете стиль — и за 30 секунд получаете живой HTML-концепт сайта." },
      },
      {
        "@type": "Question",
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: "Искусственный интеллект анализирует описание и собирает живой HTML-концепт за 30 секунд.",
    icon: "⚡",
  },
  {
    num: "03",
...
const FAQ_ITEMS = [
  {
    ...
    answer: "AI генератор сайтов — инструмент который создаёт дизайн сайта по текстовому описанию вашего бизнеса. Вы описываете компанию, выбираете стиль — за 30 секунд получаете живой HTML-концепт.",
  },
  {
  ...
  },
  {
    ...
    answer: "Мы используем Google Gemini. Генерация идёт в два этапа: один запрос отвечает за структуру и тексты, второй — за визуальное решение, поэтому разные ниши получают разную композицию, а не один шаблон с другим цветом.",
  },
  {
      ...
      <section className="relative overflow-hidden bg-[#0A0A0F] px-4 pb-16 pt-14 sm:px-6 sm:pb-24 sm:pt-20">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="reveal-up delay-2 mt-5 mx-auto max-w-2xl text-lg leading-7 text-[#A1A1B5]">
            Опишите свой бизнес — искусственный интеллект соберёт концепт сайта за 30 секунд.{" "}
        ...
        <div className="mx-auto max-w-3xl">
          <article>
            ...
            <p className="mt-4 text-[#A1A1B5] leading-7">
              ...
              работает на Google Gemini и собирает страницу в два этапа:
              отдельно структура и тексты, отдельно визуальное решение —
              палитра, типографика, порядок и оформление блоков.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-violet-500/20 bg-gradient-to-br from-violet-500/10 via-[#13131A] to-blue-500/5 p-8 text-center sm:p-14">
            ...
            <div className="relative">
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Опишите бизнес — получите концепт за 30 секунд
              </h2>
